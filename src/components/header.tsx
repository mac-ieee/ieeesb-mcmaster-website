            ...
            <nav className="max-w-7xl mx-auto px-8 py-4 flex justify-between items-center">
                <a href="#" className="flex items-center gap-3.5 no-underline">
                    ...
                    <div className="flex flex-col gap-0.5">
                        <span className="font-['Space_Grotesk'] text-lg font-bold text-ieee-blue tracking-[-0.01em]">
                            IEEE McMaster
                        </span>
                ...
                <ul className="flex gap-1 list-none items-center">
                    ...
                    <li>
                        <a
                            ...
                            className="bg-linear-to-br from-vibrant-blue to-vibrant-blue-dark text-white ml-2 px-5 py-2 shadow-[0_2px_8px_rgba(74,144,226,0.3)] rounded-lg no-underline font-medium text-[0.9375rem] transition-all duration-200 ease-in-out hover:from-vibrant-blue-dark hover:to-[#2868A8] hover:-translate-y-px hover:shadow-[0_4px_12px_rgba(74,144,226,0.4)]"
                        >
                            Join Discord
                        </a>
                    </li>
