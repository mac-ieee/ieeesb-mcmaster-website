...
export const SectionLabel = ({
    ...
    <div
        className={`inline-block text-[0.8125rem] font-semibold text-ieee-blue uppercase tracking-widest mb-4 px-3.5 py-1.5 bg-[rgba(0,98,155,0.08)] rounded-full ${className}`}
    >
        {children}
    </div>
);
...
export const SectionHeader = ({
    ...
    <div className={`text-center mb-16 ${className}`}>
        ...
        {subtitle && (
            <p className="text-lg text-[#536471] max-w-160 mx-auto leading-[1.7]">
                {subtitle}
            </p>
        )}
    </div>
